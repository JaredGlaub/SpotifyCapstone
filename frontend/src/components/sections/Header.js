...
//             <MenuItem component = {Link} to="/SpotifyVideos">Spotify Videos </MenuItem>
//             <MenuItem isLast>
//               <form>
...
const Header = (props) => {
  ...
  return (
    <Flex
      ...
      p={8}
      bg={["primary.500", "primary.500", "transparent", "transparent"]}
      color={["gray.200", "gray.200", "primary.700", "primary.700"]}
      {...props}
    >
      <Flex align="center">
        <Logo
      ...
      >
        <Flex
          ...
          pt={[4, 4, 0, 0]}
        >
          {/* <MenuItems to="/Animated">Animated</MenuItems>
          <MenuItems to="/Training">Training</MenuItems>
          <MenuItems to="/DoodleNet">DoodleNet</MenuItems> */}
          <MenuItems to="/SpotifyVideos">Daily Mix Vizualizer</MenuItems>
          <MenuItems to="/SpotifyViz">Spotify Charts</MenuItems>
          <MenuItems to="/Github" isLast>
            <Button
              size="sm"
              rounded="md"
              color={["primary.500", "primary.500", "black", "black"]}
